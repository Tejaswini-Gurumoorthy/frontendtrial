...
export function Extract4() {
  ...
  useEffect(()=>{
    axios
    .post("http://localhost:3002/qp", {num: 4})
    .then((response) => {
  ...
  return(
    ...
    <div className='container'>
      ...
      <div>
        ...
        <button className="btn next right" onClick={onSubmitt}><a href></a>Submit</button></div>
        </div>
    </div>
    </>
  )
